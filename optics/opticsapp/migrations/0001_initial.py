    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "squadron_name",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Squadron Name"
                    ),
                ),
                (
                    "squadron_url",
                    models.URLField(null=True, verbose_name="Squadron Website"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gun_ammo",
                    models.IntegerField(default=0, help_text="Number of gun rounds."),
                ),
                (
                    "missile_ammo",
                    models.IntegerField(default=0, help_text="Number of missiles."),
                ),
                (
                    "range_min",
                    models.DecimalField(
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Time to acquire (secs).",
                        max_digits=8,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Enter Airframe Name", max_length=200),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "callsign",
                    models.CharField(
                        help_text="Call sign for this type of airframe.", max_length=20
                    ),
                ),
                (
                    "default_radio_freq",
                    models.CharField(
                        help_text="Default radio frequency.", max_length=15
                    ),
                ),
                (
                    "laser_code",
                    models.CharField(help_text="Starting laser code.", max_length=10),
                ),
                ("date_created", models.DateTimeField(auto_now_add=True, null=True)),
                ("date_modified", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "callsign",
                    models.CharField(help_text="Enter Flight Callsign", max_length=200),
                ),
                (
                    "flight_coordination",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flight_lead",
                    models.BooleanField(default=False, verbose_name="Flight Lead"),
                ),
                (
                    "package_lead",
                    models.BooleanField(default=False, verbose_name="Package Lead"),
                ),
                (
                    "pilot",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Enter Mission Name", max_length=200),
                ),
                (
                    "description",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Enter Status Type", max_length=20),
                ),
                ("date_created", models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter Terrain Map Name.", max_length=20
                    ),
                ),
                ("date_created", models.DateTimeField(auto_now_add=True, null=True)),
                ("date_modified", models.DateTimeField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timezone",
                    models.CharField(default="Australia/Melbourne", max_length=100),
                ),
                (
                    "squadron",
                    models.ForeignKey(
                        default=optics.opticsapp.models.Squadron.get_default_pk,
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="opticsapp.squadron",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Enter notes for the waypoint.", null=True
                    ),
                ),
                (
                    "flight",
